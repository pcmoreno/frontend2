export default {
    ...
    "tasks_overview_click_to_show_all_participants": "Click here to load the complete overview.",
    "tasks_overview_only_shows_most_recent_entries": "This overview only shows the latest participants.",
