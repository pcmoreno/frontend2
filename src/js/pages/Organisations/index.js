...
import * as formActions from 'neon-frontend-utils/src/components/Form/actions/form';
...
class Index extends Component {
    ...
    openModalToAmendParticipant(participantId, participantStatus, participantSlug) {
        ...
        this.getFormFields('amendParticipant', {
            ...
            urlParams: {
                parameters: {
                    fields: 'accountGender,accountHasRoleEmail,accountHasRoleLanguage,consultant,account,educationLevel,accountFirstName,accountInfix,accountLastName,accountHasRoleEmail,participantSessionAppointmentDate,project'
                }
            }
        });
